...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Cette fonction permet d'extraire  les parametres d'un signal vocal modifié %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function Parametres=parametreRan(audio)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Cette partie permet  de la suppression du silence de la parole à l'aide de l'analyse de cadre par  cadre(ZCR).%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Lecture d'audio et la modification de  ses parametere de manière aléatoire.
    [data, fs] = audioread(audio);
    data = data(1:end,1)/max(data(1:end,1));
    data=ifft(0.9*fft(data).*randn(1));%Modification du fréquence aléatoirement.
    data=(0.9*data.*randn(1));%Modification de l'amplitude aléatoirement.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Parametres(3)=sqrt(VarS);% Ecart type de signal.
